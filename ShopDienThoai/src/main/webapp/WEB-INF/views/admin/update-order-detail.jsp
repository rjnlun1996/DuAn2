			...
			<div class="page-body">
				<div class="container-fluid">
					<div class="page-header">
						<div class="row">
							<div class="col-lg-6">
								<h3>FORM INSERT ORDER DETAIL FOR ORDERID: ${order.id} </h3>
								<ol class="breadcrumb">
										...
										<form:form class="theme-form  ${error ? 'was-validated' : ''}" novalidate="novalidate" modelAttribute="orderDetail" method="post" >
											<div class="card-body datetime-picker">
												...
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<form:select class="form-control product-ajax"
															name="product" id="product" required="required" path="product">
															<option value="null">--Sản phẩm--</option>
															<c:forEach var="product" items="${listProduct}">
																<form:option value="${product}"> ${product.name } - $ ${product.salePrice }</form:option>
															</c:forEach>
														</form:select>
													</div>
												</div>
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<form:input path="quantity" class="form-control" required="required" min="1" max="99"/>
												...
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<span class="badge badge-pill pill-badge-success" id="discount">0 %</span>
													</div>
												</div>
