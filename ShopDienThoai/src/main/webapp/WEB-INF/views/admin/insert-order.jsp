							...
							<div class="row">
								<div class="col-sm-12">
									<div class="card">
										...
										<form:form class="theme-form ${(error || isExistUsername || isExistEmail) ? 'was-validated' : ''}" novalidate="novalidate" modelAttribute="order" method="post" >
											<div class="card-body datetime-picker">
												...
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<form:input path="" class="form-control" required="required"  minlength="5" maxlength="20"/>
														<form:errors path="" class="invalid-feedback" />
												...
												<div class="form-group row">
													<label class="col-sm-3 col-form-label" for="receiver">Người nhận</label>
													<div class="col-sm-9">
												...
												<div class="form-group row">
													<label class="col-sm-3 col-form-label" for="address">Địa chỉ</label>
													<div class="col-sm-9">
												...
												<div class="form-group row">
													<label class="col-sm-3 col-form-label">Ngày đặt</label>
													<div class="col-sm-5">
												...
												<div class="form-group row">
													<label class="col-sm-3 col-form-label" for="total">Tổng tiền</label>
													<div class="col-sm-9">
														<form:input path="total" class="form-control" required="required" />
														<form:errors path="total" class="invalid-feedback" />
													</div>
												</div>
												<div class="form-group row">
