...
<title>HopeOnline -- Update StatusOrder</title>
<!-- Google font-->
			...
			<div class="page-body">
				<div class="container-fluid">
					<div class="page-header">
						<div class="row">
							<div class="col-lg-6">
								<h3>FORM UPDATE STATUS ORDER</h3>
								<ol class="breadcrumb">
							...
							<div class="row">
								...
								<div class="col-sm-12">
									<div class="card">
										...
										<div class="card-body">
											<form class="theme-form ${error ? 'was-validated' : ''}" novalidate="novalidate" method="post">
												<div class="card-body ">
													...
													<div class="form-group row">
														...
														<div class="col-sm-9">
															<span>
																Đơn hàng
																<b>${order.id } - ${order.account.name}</b>
															</span>
														</div>
													</div>
													<div class="form-group row">
