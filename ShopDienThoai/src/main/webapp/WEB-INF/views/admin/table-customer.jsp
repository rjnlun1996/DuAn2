...
<title>HopeOnline -- CUSTOMER</title>
<!-- Google font-->
												...
												<c:forEach var="cus" items="${list}">
													<tr>
														...
														<td>
															...
															<button class="btn btn-pill btn-outline-danger btn-sm delete-item" onClick="onDelete(this)" data-id="${cus.username}">Delete</button>
