...
<title>HopeOnline -- Insert OrderDetail </title>
<!-- Google font-->
			...
			<div class="page-body">
				<div class="container-fluid">
					<div class="page-header">
						<div class="row">
							<div class="col-lg-6">
								<h3>Form insert Order Detail for Order ID: ${order.id}</h3>
								<ol class="breadcrumb">
										...
										<form:form class="theme-form  ${error ? 'was-validated' : ''}" novalidate="novalidate" modelAttribute="orderDetail" method="post">
											<div class="card-body datetime-picker">
												...
												<div class="form-group row">
													...
													<div class="col-sm-9">
														<select class="form-control product-ajax" name="product" id="product" required="required">
															<option value="null">--Sản phẩm--</option>
															<c:forEach var="product" items="${listProduct}">
																<option value="${product.id}">${product.name } -- ${product.importPrice} VNĐ</option>
															</c:forEach>
														</select>
													</div>
												</div>
