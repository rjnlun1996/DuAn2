...
public interface ViewConstraint {	
	...
	public static final String URL_ADMIN_HOME = "/ho-admin/";
	public static final String VIEW_ADMIN_HOME = "admin/index";
	
	public static final String URL_ADMIN_ADMIN = "/ho-admin/manager/";
	...
	public static final String URL_ADMIN_PRODUCER_UPDATE = URL_ADMIN_PRODUCER + "update";
	public static final String URL_ADMIN_PRODUCER_DELETE = URL_ADMIN_PRODUCER + "delete";
	...
	public static final String URL_ADMIN_PROFILE = "/ho-admin/profile";
	public static final String URL_ADMIN_PROFILE_UPDATE = URL_ADMIN_PROFILE + "update";
